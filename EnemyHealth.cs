...
namespace TowerDefense.Enemy
{
    ...
    public class EnemyHealth : MonoBehaviour
    {
        ...
        protected int _difficulty = 1; // Default to Normal
        ...
        {
            enemyData = data;
            _difficulty = difficulty; // Store the difficulty level
        ...
        /// Armor enemies take 80% of the incoming damage, non-armor enemies take full damage.
        /// </summary>
        ...
        protected virtual void Die()
        {
            ...
            int goldReward = enemyData != null ? enemyData.GetGoldReward(_difficulty) : 10;
